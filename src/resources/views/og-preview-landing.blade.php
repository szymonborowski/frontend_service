...
<body>
    ...
    <div class="relative overflow-hidden flex items-center"
         style="width: 1200px; height: 630px; background: linear-gradient(135deg, #071017 0%, #0f172a 50%, #0d2218 100%);">

        {{-- Soft glow accents --}}
        <div class="absolute opacity-35"
             style="top: -100px; right: -100px; width: 500px; height: 500px; background: radial-gradient(circle, rgba(16,185,129,0.5), transparent 70%); filter: blur(40px);"></div>
        <div class="absolute opacity-25"
             style="bottom: -150px; left: 200px; width: 600px; height: 400px; background: radial-gradient(circle, rgba(56,189,248,0.35), transparent 70%); filter: blur(60px);"></div>
        ...
        <div class="absolute font-mono"
             style="bottom: 32px; right: 48px; font-size: 18px; color: #6b7280;">
