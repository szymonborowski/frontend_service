        ...
        <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <main class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-4">#{{ $tag['name'] }}</h1>
            ...
            <aside class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <div class="flex flex-wrap gap-2">
                        @forelse($tags as $t)
                            <a href="{{ route('tag.show', $t['slug']) }}" class="inline-flex items-center px-2 py-1 rounded text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-sky-100 dark:hover:bg-sky-900/30 hover:text-sky-700 dark:hover:text-sky-400 {{ ($t['slug'] ?? '') === ($tag['slug'] ?? '') ? 'bg-sky-100 dark:bg-sky-900/30 text-sky-700 dark:text-sky-400' : '' }}">
                                #{{ $t['name'] }}
                            </a>
                        @empty
